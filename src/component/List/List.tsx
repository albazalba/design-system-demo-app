...
export const List = (props: ListProps) => {
	return (
		<StyledList {...props} style={props.style}>
			{props.lists.map((list: any) => (
				list.link ? <NavLink to={list.link} activeStyle={list.activeStyle} style={{textDecoration:"none", color:"black"}}> 
					<ListItem hoverEffect={list.hoverEffect} disabled={list.disabled} onClick={list.onClick} >
						{list.icon && <ListItemIcon>{list.icon}</ListItemIcon>}
						<ListItemText primary={list.primaryText} secondary={list.secondaryText} style={list.style} />
					</ListItem>
				</NavLink> 
				: 
				<ListItem hoverEffect={list.hoverEffect} disabled={list.disabled} onClick={list.onClick} >
...
export const ListItemText: React.FC<ListItemTextProps>= (props) => {
	...
	return <StyledListItemText style={style}>
